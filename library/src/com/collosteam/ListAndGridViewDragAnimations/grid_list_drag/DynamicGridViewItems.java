 ...
 */
public class DynamicGridViewItems extends GridView {
    ...
    public DynamicGridViewItems(Context context) {
        super(context);
        init(context);
    }

    public DynamicGridViewItems(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public DynamicGridViewItems(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private OnItemClickListener mOnItemClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ((StableArrayAdapterGridMenuItems) getAdapter()).getItem(position).getGetClickAction().onClick(view);
        }
    };
    ...
    private OnItemLongClickListener mOnItemLongClickListener =
            new OnItemLongClickListener() {
                public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int pos, long id) {
                    ...
                    // ImageView imageView=(ImageView) selectedView.findViewById(R.id.circle);
    ...
    private Bitmap getBitmapWithBorder(View v) {
        ...
        return scaleBitmap(bitmap, (int) ((float) bitmap.getWidth() * 0.9f), (int) ((float) bitmap.getHeight() * 0.9f));
    }
    ...
    public static Bitmap scaleBitmap(Bitmap bitmap, int newWidth, int newHeight) {
        ...
        float pivotX = Math.abs(newWidth - (float) bitmap.getWidth());
        float pivotY = Math.abs(newHeight - (float) bitmap.getHeight());
        Bitmap scaledBitmap = Bitmap.createBitmap(newWidth, newHeight, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(scaledBitmap);
        canvas.translate(-pivotX / 2, -pivotY / 2);
    ...
    public View getViewForPosition(int position) {
        ...
        StableArrayAdapterGridMenuItems adapter = ((StableArrayAdapterGridMenuItems) getAdapter());
    ...
    private void touchEventsEnded() {
        ...
        if (mCellIsMobile || mIsWaitingForScrollFinish) {
            ...
            long positions[] = new long[getAdapter().getCount()];
            for (int i = 0; i < getAdapter().getCount(); i++) {
                positions[i] = ((StableArrayAdapterGridMenuItems) getAdapter()).getItem(i).getId();
            }
            new SettingsManager(getContext()).setMenuOrdering(positions);

            Log.i("SettingsManager", Arrays.toString(positions));
