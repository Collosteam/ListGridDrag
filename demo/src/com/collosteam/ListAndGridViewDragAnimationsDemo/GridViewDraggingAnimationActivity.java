...
import com.collosteam.ListAndGridViewDragAnimations.grid_list_drag.DynamicGridView;
...
public class GridViewDraggingAnimationActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StableArrayAdapter adapter = new StableArrayAdapter(this, R.layout.item_drag_grid_view, mCheeseList);
